...
import com.lin.service.EmitterService;
import com.lin.service.HttpService;
...
public class TestController {
    ...
    @GetMapping("test")
    public HttpResult<String> test(@RequestParam("name") String name, @RequestParam("age") int age) {
        return HttpResult.success("Hello " + name + " " + age);
    }

    @GetMapping("test/{id}")
    public HttpResult<String> test(@PathVariable String id) {
